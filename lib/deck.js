...
_.extend(Deck.prototype, binder, hasEmitter, /** @lends Deck.prototype */ {
  ...
  bindCanvasGestureHandlerEmitterEvents: function bindCanvasGestureHandlerEmitterEvents() {
    this.canvas.bindGestureHandlerEmitterEvents();
  },

  unbindCanvasGestureHandlerEmitterEvents: function unbindCanvasGestureHandlerEmitterEvents() {
    this.canvas.unbindGestureHandlerEmitterEvents();
  },
  ...
  setItemCollection: function setItemCollection(itemCollection) {
    ...
    // If the ItemCollection has a different emitter, bind to the item collection emitter and
    // forward all events on the main Deck emitter.
  ...
  setLayout: function setLayout(layout) {
    ...
    // Unbind events from the old layout
    if (this.layout) {
  ...
  onAnyEvent: function onAnyEvent(e) {
    if (this.config.debugEvents) {
      console.log("Deck#onAnyEvent:", e);
    }
  },

  onItemCollectionEvent: function onItemCollectionEvent(e) {
