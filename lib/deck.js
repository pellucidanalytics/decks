...
_.extend(Deck.prototype, /** @lends Deck.prototype */ {
  ...
  setItemCollection: function(itemCollection) {
    ...
    console.log("deck: itemCollection set", itemCollection);
  ...
  setViewport: function(viewport) {
    ...
    console.log("deck: viewport set", this.viewport);
  ...
  setLayout: function(layout) {
    ...
    this.layout = layout;
    console.log("deck: layout set", this.layout);
