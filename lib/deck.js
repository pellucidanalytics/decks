...
_.extend(Deck.prototype, binder, hasEmitter, /** @lends Deck.prototype */ {
   ...
   * @return {undefined}
   */
  panToItem: function(itemOrItemId, renderIdOrIndex) {
    var item;
    if (itemOrItemId instanceof Item) {
      ...
      item = this.getItem(itemOrItemId.id);
    }
   ...
   * @return {undefined}
   */
  setLayoutAndPanToItem: function(layout, itemOrItemId, renderIdOrIndex) {
    var self = this;
  ...
  bindCanvasGestureHandlerEmitterEvents: function() {
    this.canvas.bindGestureHandlerEmitterEvents();
  },

  unbindCanvasGestureHandlerEmitterEvents: function() {
