...
module.exports = {
  ...
  normalize: function normalize(r) {
    ...
    if (r.isNormalized) {
      // Clone the element, to avoid the chance that we modify the source object somewhere downstream
      return _.clone(r);
    }
  ...
  resizeToWidth: function resizeToWidth(r, width) {
    r = this.normalize(r);
    return this.resizeTo(r, width, r.height);
  },
  ...
  resizeToHeight: function resizeToHeight(r, height) {
    r = this.normalize(r);
    return this.resizeTo(r, r.width, height);
  },
  ...
  moveToX: function moveToX(r, x) {
    r = this.normalize(r);
    return this.moveTo(r, x, r.top);
  },

  moveToY: function moveToY(r, y) {
    r = this.normalize(r);
    return this.moveTo(r, r.left, y);
  },
