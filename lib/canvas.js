...
_.extend(Canvas.prototype, binder, hasEmitter, /** @lends Canvas.prototype */ {
  ...
  setBounds: function setBounds(bounds) {
    ...
    if (this.frameBounds) {
      ...
      console.warn("Canvas#setBounds: not restricting Canvas overflow - frameBounds not set");
    }
  ...
  resizeToFitAllElements: function resizeToFitAllElements() {
    ...
    var bounds = rect.union(allElementsBounds, this.bounds, this.frameBounds);
  ...
  bindGestureHandlerEmitterEvents: function bindGestureHandlerEmitterEvents() {
    if (!this.gestureHandler) {
      return;
    }
    this.gestureHandler.bindEmitterEvents();
  },

  unbindGestureHandlerEmitterEvents: function unbindGestureHandlerEmitterEvents() {
    if (!this.gestureHandler) {
      return;
    }
    this.gestureHandler.unbindEmitterEvents();
  },
