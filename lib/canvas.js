...
_.extend(Canvas.prototype, binder, hasEmitter, /** @lends Canvas.prototype */ {
  ...
  emitterEvents: {
    ...
    "viewport:render:animation:begin": "onViewportRenderAnimationBegin",
  ...
  resizeToFitAllElements: function() {
    var itemClassName = this.config.itemClassName;

    // Convert DOM list data type to a plain Array
    var elements = _.map(this.element.getElementsByClassName(itemClassName), _.identity);
  ...
  */
  ...
  onViewportRenderAnimationBegin: function(e) {
    var render = e.data;
