...
_.extend(ItemCollection.prototype, binder, hasEmitter, /** @lends ItemCollection.prototype */ {
  ...
  addItem: function(item, options) {
    if (!item) {
      throw new Error("ItemCollection#addItem: item is required");
    }
  ...
  addItems: function(items, options) {
    if (!_.isArray(items)) {
      throw new Error("ItemCollection#addItems: items are required and must be an Array");
    }
  ...
  removeItem: function(item, options) {
    if (!(item instanceof Item)) {
      throw new Error("ItemCollection#removeItem: item is required and must be an Item");
    }
