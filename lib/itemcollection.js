...
_.extend(ItemCollection.prototype, binder, hasEmitter, /** @lends ItemCollection.prototype */ {
  ...
  addItem: function(item, options) {
    ...
    if (!options.silent) {
      this.emitter.emit(DecksEvent("item:collection:item:added", this, item));
    }
  ...
  addItems: function(items, options) {
    ...
    if (!options.silent) {
      this.emitter.emit("item:collection:items:added");
    }
  ...
  removeItem: function(item, options) {
    ...
    if (!options.silent) {
      this.emitter.emit(DecksEvent("item:collection:item:removed", this, item));
    }
  ...
  clear: function(options) {
    ...
    if (!options.silent) {
      this.emitter.emit(DecksEvent("item:collection:cleared", this));
    }
  },
  ...
  setFilter: function(filter, options) {
    ...
    if (!options.silent) {
      this.emitter.emit(DecksEvent("item:collection:filter:changed", this, this.filter));
    }
  ...
  setSortBy: function(sortBy, options) {
    ...
    if (!options.silent) {
      this.emitter.emit(DecksEvent("item:collection:sortBy:changed", this, this.sortBy));
    }
  ...
  setReversed: function(isReversed, options) {
    ...
    if (!options.silent) {
      this.emitter.emit(DecksEvent("item:collection:isReversed:changed", this, this.isReversed));
    }
  ...
  index: function() {
    ...
    this.emitter.emit(DecksEvent("item:collection:indexed", this));
  },
