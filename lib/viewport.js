...
_.extend(Viewport.prototype, binder, hasEmitter, /** @lends Viewport.prototype */ {
  ...
  drawItem: function(item) {
    ...
    var layoutRenders = this.layout.getRenders(item, options) || [];
  ...
  */
  ...
  onAnimationComplete: function(render) {
    ...
    //console.log("rendersDrawing", this.rendersDrawing);
    this.rendersDrawing--;
    if (this.rendersDrawing === 0) {
      //console.log("done drawing renders", this.rendersDrawing);
