...
_.extend(Viewport.prototype, binder, hasEmitter, /** @lends Viewport.prototype */ {
  ...
  drawRender: function(render) {
    ...
    // configs (need to find a better place)
    var itemsPerSlot = 15,
        maxSlotIndexForAnimations = 2, /* animations are only applied for total items = itemsPerSlot * (maxSlotIndexForAnimations + 1) */
        slotRenderDelay = 100;

    /*
      // settings for mobile
      var itemsPerSlot = 8,
          maxSlotIndexForAnimations = 2,
          slotRenderDelay = 100;
     */
    ...
    // reset delay to 0 - not needed - (should happen in CDP)
