...
_.extend(Viewport.prototype, binder, hasEmitter, /** @lends Viewport.prototype */ {
  ...
  drawItem: function(item, options) {
    ...
    var layoutOptions = this.getLayoutMethodOptions();
    var layoutRenders = this.layout.getRenders(item, layoutOptions) || [];
  ...
  createRenderElement: function(item, render) {
    ...
    // Allow the layout to set the "unloaded" state for the new element
  ...
  loadRender: function(render) {
    ...
    var options = this.getLayoutMethodOptions();

    this.layout.loadRender(render, options);
  ...
  unloadRender: function(render) {
    ...
    this.layout.unloadRender(render, options);
  },
  ...
  onAnimationProgress: function(render) {
    ...
    this.throttledLoadOrUnloadRenders(render);
  },
