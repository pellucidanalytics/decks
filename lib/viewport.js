...
_.extend(Viewport.prototype, {
  ...
  drawItemRender: function(options) {
    ...
    newRender.element = (currentRender && currentRender.element) || this.itemRenderer.getRenderContainer(options);
  ...
  getAnimateOptions: function(options) {
    ...
    var globalOptions = this.itemRenderer.getRenderAnimateOptions(options);
