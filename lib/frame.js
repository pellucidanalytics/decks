...
_.extend(Frame.prototype, binder, hasEmitter, /** @lends Frame.prototype */ {
  ...
  setConfig: function(config) {
    if (!config) {
      throw new Error("Frame#setConfig: config is required");
    }

    if (this.config) {
      throw new Error("Frame#setConfig: config already set");
    }
  ...
  setElement: function(element) {
    if (!_.isElement(element)) {
      throw new Error("Frame#setElement: element is required and must be an Element");
    }

    if (this.element) {
      throw new Error("Frame#setElement: element already set");
    }
  ...
  isElementVisible: function(element) {
    if (!_.isElement(element)) {
      throw new Error("Frame#isElementVisible: element is required and must be an Element");
    }
