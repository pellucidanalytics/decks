...
_.extend(Frame.prototype, binder, /** @lends Frame.prototype */ {
  ...
  onCanvasElementSet: function(e) {
    ...
    // TODO: there might be a better way tot do this - the problem is that the Frame bounds are
    // set and an event is emitted before the Canvas has been initialized
    // Set the initial canvas bounds to match the frame
    canvas.setBounds(this.bounds);
  },
