...
var dom = {
  ...
  getStyle: function(element, name, options) {
    if (!_.isElement(element)) {
      throw new Error("dom.getStyle: element is required");
    }

    if (!_.isString(name)) {
      throw new Error("dom.getStyle: name is required");
    }
  ...
  setStyle: function(element, name, value, options) {
    if (!_.isElement(element)) {
      throw new Error("dom.setStyle: element is required");
    }

    if (!_.isString(name)) {
      throw new Error("dom.setStyle: name is required");
    }

    if (_.isUndefined(value)) {
      throw new Error("dom.setStyle: value is required");
    }
  ...
  setStyles: function(element, styles, options) {
    if (!_.isElement(element)) {
      throw new Error("dom.setStyles: element is required");
    }
  ...
  isPositioned: function(element) {
    if (!_.isElement(element)) {
      throw new Error("dom.isPositioned: element is required");
    }
