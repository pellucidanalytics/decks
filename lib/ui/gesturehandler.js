...
_.extend(GestureHandler.prototype, binder, hasEmitter, /** @lends GestureHandler.prototype */ {
  ...
  resetPosition: function(duration) {
    var self = this;
    duration = duration || 200;

    self.emit(DecksEvent("gesture:position:resetting", this, this.element));
    ...
    if (self.movement.scroll) {
      ...
      var done = function() {
        doneCount++;
        if (doneCount === 2) {
          self.emit(DecksEvent("gesture:position:reset", this, this.element));
        }
      };
      ...
      self.animator.animate(self.element, {
        top: 0,
        left: 0
      }, {
        duration: duration,
  ...
  moveX: function(e, elementRect) {
    ...
    if (self.movement.scroll) {
      ...
      self.animator.animate(this.element, {
        left: left
      }, {
        duration: 0,
        queue: false,
  ...
  onGesturePanStart: function(e) {
    ...
    this.updateCurrentPosition(e.data);
  },
