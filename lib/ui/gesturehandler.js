...
_.extend(GestureHandler.prototype, binder, hasEmitter, /** @lends GestureHandler.prototype */ {
   ...
   * @return {undefined}
   */
  onGesturePanStart: function onGesturePanStart(e) {
   ...
   * @return {undefined}
   */
  onGesturePanAny: function onGesturePanAny(e) {
    if (e.sender.element !== this.element) {
      return;
    }
   ...
   * @return {undefined}
   */
  onGesturePanX: function onGesturePanX(e) {
    if (e.sender.element !== this.element) {
      return;
    }
   ...
   * @return {undefined}
   */
  onGesturePanY: function onGesturePanY(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGesturePanEnd: function onGesturePanEnd(e) {
    var self = this;
  ...
  onGesturePanCancel: function onGesturePanCancel(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGestureSwipeAny: function onGestureSwipeAny(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGestureSwipeX: function onGestureSwipeX(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGestureSwipeY: function onGestureSwipeY(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGestureTap: function onGestureTap(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGesturePress: function onGesturePress(e) {
    if (e.sender.element !== this.element) {
      return;
    }
  ...
  onGestureScroll: function onGestureScroll(e) {
