...
_.extend(GestureHandler.prototype, binder, hasEmitter, /** @lends GestureHandler.prototype */ {
  ...
  updatePositionData: function(e) {
    ...
    if (!this.startPosition) {
      console.log("updateStartPosition");
      this.startPosition = this.currentPosition;
    }
  },

  clearPositionData: function() {
    console.log("clearPositionData");
  ...
  animateMoveX: function(value, animateOptions, beginOptions, completeOptions) {
    this.animateMoveXOrY(value, "x", animateOptions, beginOptions, completeOptions);
  },

  animateMoveY: function(value, animateOptions, beginOptions, completeOptions) {
    this.animateMoveXOrY(value, "y", animateOptions, beginOptions, completeOptions);
  },
  ...
  animateMoveXOrY: function(value, axis, animateOptions, beginOptions, completeOptions) {
    ...
    animateOptions = _.extend({
      complete: function() {
        ...
        console.log("count " + completeOptions.count);
        if (completeOptions.count < 2 && completeOptions.waitForXAndY) {
          console.warn("suppressed animation complete");
          return;
        }
  ...
  onGesturePanCancel: function(/*e*/) {
    ...
    // The event doesn't seem to happen much or at all - not sure what causes it
    if (this.isAnimating) {
