...
_.extend(GestureHandler.prototype, binder, hasEmitter, /** @lends GestureHandler.prototype */ {
  ...
  setOptions: function(options) {
    ...
    if (this.snapping.toChildElements && !_.isString(this.snapping.childElementSelector)) {
      throw new Error("GestureHandler#setOptions: for options.snapping.toChildElements === true, options.snapping.childElementSelector is required");
    }
