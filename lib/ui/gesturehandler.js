...
function GestureHandler(options) {
  ...
  if (options.movement.debouncedScrollWait > 0) {
    this.onGestureScroll = _.debounce(this.onGestureScroll, options.movement.debouncedScrollWait);
  }
