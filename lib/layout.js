...
_.extend(Layout.prototype, binder, /** @lends Layout.prototype */ {
   ...
   * @return {undefined}
   */
  shouldLoadRender: function(/*render, options*/) {
    return false;
  },
   ...
   *
   * @param {Object} options - object off all decks objects (viewport, frame, etc.)
   * @return {undefined}
   */
  getCustomRenders: _.noop,
   ...
   *
   * @param {Item} item - item being panned to
   * @param {Object} render - render being panned to
   * @return {undefined}
   */
  getPanToItemOffsets: function() {
    return { x: 0, y: 0 };
  }
});
