...
var hasEmitter = {
  ...
  bindEmitterEvents: function() {
    validate(this.bindEvents, "bindEvents", { isFunction: true });
    validate(this.emitterEvents, "emitterEvents", { isPlainObject: true });
    this.bindEvents(this.emitter, this.emitterEvents);
  },

  unbindEmitterEvents: function() {
    validate(this.unbindEvents, "unbindEvents", { isFunction: true });
    validate(this.emitterEvents, "emitterEvents", { isPlainObject: true });
