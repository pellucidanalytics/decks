  ...
  getBindMethodName: function(source, eventName) {
    if (eventName === "*" || eventName === "**") {
      if (_.isFunction(source.onAny)) {
        ...
        throw new Error("binder#getBindMethodName: source object does not have an onAny method");
      }
    }
    ...
    if (!name) {
      throw new Error("binder#getBindMethodName: source object does not have an event binding method");
    }
  ...
  getUnbindMethodName: function(source, eventName) {
    if (eventName === "*" || eventName === "**") {
      if (_.isFunction(source.offAny)) {
        ...
        throw new Error("binder#getUnbindMethodName: source does not have an offAny method");
      }
    }
    ...
    if (!name) {
      throw new Error("binder#getUnbindMethodName: source object does not have an event unbinding method");
    }
