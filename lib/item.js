...
_.extend(Item.prototype, {
  ...
  setIndex: function(data, options) {
    ...
    this.index = index;
    if (!options.silent) {
      this.emit("item:index:changed", { item: this, index: this.index });
    }
  },
  ...
  setData: function(data, options) {
    ...
    if (_.isEqual(this._data, data) && !options.force) {
      return;
    }
    ...
    if (!options.silent) {
      this.emit("item:changed", { item: this, oldData: oldData, data: data });
    }
  },
